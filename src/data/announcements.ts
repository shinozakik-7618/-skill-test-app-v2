...
export const announcements: Announcement[] = [
  // 重要なお知らせ（バグ修正、削除機能など）
  {
    ...
    content: '3つの重要なバグを修正しました。【修正内容】①実施履歴の日付ずれ問題を解決（UTC→JST変換の改善により、正確な実施日時が表示されるようになりました）、②復習ノートの間違い回数が2倍に表示される問題を解決（復習ノート更新タイミングを最適化し、正確な間違い回数が記録されるようになりました）、③10問目の回答が表示されない問題を解決（最終問題の結果が確実に保存されるように改善しました）。これらの修正により、より正確で信頼性の高い学習管理が可能になりました。',
