...
export const announcements: Announcement[] = [
  ...
  },
  {
    id: 'ann-011',
    type: 'update',
    title: 'AI・DX基礎知識カテゴリーを8問に拡充',
    content: 'AI・DX基礎知識カテゴリーに3問を追加し、合計8問になりました。日本新聞協会のAI基本計画意見書に関する最新の問題を追加し、AI事業者の情報公開要請、報道コンテンツ無断利用の影響、企業の責任ある姿勢など、より実践的な内容を学習できます。',
    category: 'AI・DX基礎知識',
