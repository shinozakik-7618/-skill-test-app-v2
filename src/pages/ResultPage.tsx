  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* 間違えた問題セクション */}
        {incorrectCount > 0 && (
          <div id="incorrect-questions" className="space-y-6 mb-8">
            ...
            {questions.map((question, index) => {
              ...
              return (
                <div 
                  key={question.id} 
                  className="bg-white rounded-xl shadow-lg p-6 border-2 border-red-200 cursor-pointer hover:shadow-xl transition-shadow"
                ...
                >
                  ...
                  <div className="flex items-start mb-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-xl mr-4 bg-red-100 text-red-600">
                      ✗
                    </div>
