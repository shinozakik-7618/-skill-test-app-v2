...
export default function TestPage() {
  ...
  const [testMode, setTestMode] = useState<TestMode>('learning');
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* 学習モード */}
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">📚 学習モード</h2>
            <div className="space-y-3">
              <button
                onClick={() => startTest('all', 'learning')}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mt-1">カテゴリー内のすべての問題からランダムに出題。問題ごとに解説が表示されます。</p>
              </button>
              <button
                onClick={() => startTest('unanswered', 'learning')}
              ...
              <button
                onClick={() => startTest('incorrect', 'learning')}
          ...
          {/* 試験モード */}
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">🎯 試験モード</h2>
            <div className="space-y-3">
              <button
                onClick={() => startTest('all', 'exam')}
                className="w-full p-5 bg-white rounded-xl border-2 border-gray-200 hover:border-purple-500 hover:bg-purple-50 transition-all text-left"
              >
                <h3 className="text-lg font-semibold text-gray-900">すべての問題</h3>
                <p className="text-sm text-gray-600 mt-1">テスト中は解説が表示されません。結果画面で全問題の解説を確認できます。</p>
              </button>
              <button
                onClick={() => startTest('unanswered', 'exam')}
                className="w-full p-5 bg-white rounded-xl border-2 border-gray-200 hover:border-purple-500 hover:bg-purple-50 transition-all text-left"
              >
                <h3 className="text-lg font-semibold text-gray-900">未回答の問題のみ</h3>
                <p className="text-sm text-gray-600 mt-1">まだ解答していない問題のみが出題されます。</p>
              ...
              <button
                onClick={() => startTest('incorrect', 'exam')}
                className="w-full p-5 bg-white rounded-xl border-2 border-gray-200 hover:border-purple-500 hover:bg-purple-50 transition-all text-left"
              >
                <h3 className="text-lg font-semibold text-gray-900">不正解の問題のみ</h3>
                <p className="text-sm text-gray-600 mt-1">過去に間違えた問題のみが出題されます。復習に最適です。</p>
