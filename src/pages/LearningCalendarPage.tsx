            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-2xl font-bold mb-2">
                  {consecutiveDays >= 30 ? '🏆 素晴らしい！学習マスター！' :
                   consecutiveDays >= 14 ? '🔥 絶好調！継続は力なり！' :
                   consecutiveDays >= 7 ? '⭐ 1週間達成！すごい！' :
                   consecutiveDays >= 3 ? '💪 3日連続！調子がいいですね！' :
                   '🌟 学習スタート！頭がいいですね！'}
                </h3>
                <p className="text-sm opacity-90">
                  {consecutiveDays >= 30 ? '30日連続は適いなかできません！この調子で頑張りましょう！' :
                   consecutiveDays >= 14 ? '2週間以上の継続！学習が習慣になっていますね！' :
                   consecutiveDays >= 7 ? '1週間達成！素晴らしいペースです！' :
                   consecutiveDays >= 3 ? '3日連続は立派です！このまま続けましょう！' :
                   '毎日少しずつが大事！今日も頑張りましょう！'}
                </p>
              </div>
