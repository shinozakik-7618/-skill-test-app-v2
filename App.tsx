...
import QuestionDetailPage from './pages/QuestionDetailPage'; // 🆕 問題詳細
import StatsPage from './pages/StatsPage'; // 🆕 成績管理
    ...
    <Router>
      <div className="min-h-screen bg-gray-50">
        <Routes>
          ...
          <Route path="/mode-select/:category" element={<ModeSelectionPage />} /> {/* 🆕 モード選択 */}
          <Route path="/test/:category" element={<TestPage />} />
          <Route path="/result" element={<ResultPage />} />
          <Route path="/question-detail" element={<QuestionDetailPage />} /> {/* 🆕 問題詳細 */}
          ...
          <Route path="/stats" element={<StatsPage />} /> {/* 🆕 成績管理 */}
